...
<div class="page container">
   <div class="row">
            <div class="contact-info col-lg-12 mt-5 res-margin">
               <h3>Sign Up</h3>
               <!-- Form Starts -->
               <form action="UserSignupServlet" method="GET" enctype = "multipart/form-data">
               <div id="contact_form">
                  <div class="form-group">
                     <div class="row">
                        <div class="col-md-3">
                           <label>First Name<span class="required">*</span></label>
                           <input type="text" name="fname" class="form-control input-field" required=""> 
                        </div>
                        <div class="col-md-3">
                           <label>Last Name</label>
                           <input type="text" name="lname" class="form-control input-field"> 
                        </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                           ...
                           <input type="text" name="postalcode" class="input-field form-control" required="">
                        </div>
                        <div class="col-md-4">
                           <label>City<span class="required">*</span></label>
                           <input name="city" class="input-field form-control" required="">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                           <button type="submit" id="submit_btn" value="Submit" class="btn btn-secondary">Submit</button>
                        </div>
                     </div>
                  </div>
                  <!-- /form-group-->
