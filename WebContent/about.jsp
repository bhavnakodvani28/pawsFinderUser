...
<!-- Mirrored from www.ingridkuhn.com/themes/unitedpets/boxed/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Dec 2020 12:39:13 GMT -->
                  ...
                  <div class="collapse navbar-collapse" id="navbarResponsive">
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                         ...
                         <!-- menu item -->
                         <li class="nav-item">
                           <a class="nav-link" href="adoption.html">Adopt
                           </a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="donation.html">Donate
                           </a>
                        </li>
                       <!-- <li class="nav-item dropdown">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="QandA.html">QandA
                           </a>
                        </li>
                        <!-- menu item -->
                        <!--<li class="nav-item dropdown">
...
<div class="page">
   <div class="container about-section block-padding no-bg-small">
      ...
      <div class="row pb-3">
         <div class="col-lg-6">
            <h2>Our Mission</h2>
            <p class="mt-3 res-margin">Make people aware about Adoption of dog.</p>
            <h5 class="mt-2">We have over 3 years of experience</h5>
            <p>Our team works day and night from the bottom of there heart from past more than 3 years.</p>
            <!-- Buttons -->	 
            <a href="contact.html" class="btn btn-primary mt-4">Contact us</a>
            <a href="services.html" class="btn btn-secondary mt-4 ml-1">Our services</a>
         </div>
         <!-- /col-lg-6-->
      </div>
      <!-- /row -->
   ...
   <div class="container block-padding">
      ...
      <div class="row ">
         <div class="col-lg-6">
            ...
            <p class="res-margin">Aliquam erat volutpat In id fermentum augue, ut pellentesque leo. Maecenas at arcu risus. Donec commodo sodales ex, scelerisque laoreet nibh hendrerit id. In aliquet magna nec lobortis maximus. Etiam rhoncus leo a dolor placerat, nec elementum ipsum convall.</p>
...
<div class="row text-lg-right">
   <div class="col-md-6 col-lg-3">
      ...
      <div class="feature-with-icon">
         ...
         <p>We use natural products on dog to protect there skin.</p>
      </div>
      <!-- /feature-with-icon-->
      <!-- feature -->
      <div class="feature-with-icon">
         ...
         <p>We have a team of doctors who take cares of the dogs clinical needs.</p>
      </div>
      <!-- /feature-with-icon-->
      <!-- feature -->
      <div class="feature-with-icon">
         ...
         <p>We have team of trainers to trsin the dog.</p>
      </div>
      <!-- /feature-with-icon-->
   </div>
   <div class="col-md-6 col-lg-3 text-left pt-3 pt-sm-0 order-lg-12">
      ...
      <div class="feature-with-icon">
         ...
         <p>We have housing facility for more than 3000 dogs.</p>
      </div>
      <!-- /feature-with-icon-->
      <!-- feature -->
      <div class="feature-with-icon">
         ...
         <p>We help people to adopt the dog depending on there need</p>
      </div>
      <!-- /feature-with-icon-->
      <!-- feature -->
      <div class="feature-with-icon">
         ...
         <p>We take care of dogs day and night with the help of amazing volunteers.</p>
      </div>
      <!-- /feature-with-icon-->
   </div>
   <!-- /col-l -->
